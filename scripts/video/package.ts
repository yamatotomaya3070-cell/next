...
依頼書とこの編集指示書のとおりに、上から順番に編集してください。
...
- 最後まで編集したら、依頼書・編集指示書のとおりになっているか確認する
...
export function buildManualSteps(
  ...
  steps.push(
    ...
    { text: "最初から最後まで再生して、依頼書・編集指示書のとおりになっているか確認します。", tip: null },
...
export function buildPackage(
  ...
  if (realistic) {
    instructionDoc +=
      ...
      `- 素材の並び順は、そのまま使う順番とは限りません。自分で構成を考えてください。\n` +
